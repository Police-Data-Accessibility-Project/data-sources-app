...
class GetUserByIdQueryBuilder(QueryBuilderBase):
    ...
    def run(self) -> UserProfileResponseSchemaInnerDTO:
        query = (
            ...
            .options(
                ...
                selectinload(User.recent_searches).selectinload(
                    RecentSearch.record_categories
                ),
                ...
                .selectinload(LinkUserFollowedLocation.location)
                .selectinload(Location.locality),
                selectinload(User.data_requests).selectinload(DataRequest.data_sources),
                selectinload(User.data_requests).selectinload(DataRequest.locations),
                selectinload(User.data_requests).selectinload(
                    DataRequest.github_issue_info
                ),
    ...
    def _process_external_accounts(
        ...
        return ExternalAccountDTO(github=github_account)
    ...
    def _process_data_requests(
        ...
        return GetManyDataRequestsResponseDTO(data=results)
