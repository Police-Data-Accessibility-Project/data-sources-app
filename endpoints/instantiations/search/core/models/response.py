...
class SearchResponseInnerDTO(BaseModel):
    results: list[SearchResultDTO] = default_field_required(
...
class SearchResponseJurisdictionsWrapperDTO(BaseModel):
    federal: SearchResponseInnerDTO = default_field_required(
        "The list of federal search results."
    )
    state: SearchResponseInnerDTO = default_field_required(
        "The list of state search results."
    )
    county: SearchResponseInnerDTO = default_field_required(
        "The list of county search results."
    )
    locality: SearchResponseInnerDTO = default_field_required(
        "The list of city search results."
    )


class SearchResponseDTO(BaseModel):
    data: SearchResponseJurisdictionsWrapperDTO = default_field_required(
        "The list of search results."
    )
    count: int = default_field_required("The count of the search results.")
