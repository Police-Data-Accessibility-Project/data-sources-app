...
from endpoints.v3.sync.meta_urls.add.query import SourceManagerAddMetaURLsQueryBuilder
...
def source_manager_add_meta_urls(
    ...
    try:
        ...
        return db_client.run_query_builder(SourceManagerAddMetaURLsQueryBuilder(request))
