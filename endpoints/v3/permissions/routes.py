...
from middleware.security.auth.fastapi import access_with, get_standard_access_info, access_with_user_create_update, \
...
def get_permission_list() -> GetPermissionListResponse:
    return run_query_builder(
        GetPermissionMappingsQueryBuilder()
    )
...
def get_user_permissions(
    ...
    return get_user_permissions_wrapper(
        user_id=user_id
    )
...
def add_user_permission(
    ...
    return add_user_permission_wrapper(
        user_id=user_id,
