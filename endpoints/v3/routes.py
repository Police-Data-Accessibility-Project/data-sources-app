...
from endpoints.v3.follows.query import GetUserFollowsSourceCollectorQueryBuilder
from endpoints.v3.follows.response import GetFollowsResponse
from endpoints.v3.sync.agencies.add.request import AddAgenciesOuterRequest
from endpoints.v3.sync.agencies.add.wrapper import source_manager_add_agencies
from endpoints.v3.sync.agencies.delete.exceptions import OrphanedEntityException
from endpoints.v3.sync.agencies.delete.wrapper import source_manager_delete_agencies
from endpoints.v3.sync.agencies.update.request import UpdateAgenciesOuterRequest
from endpoints.v3.sync.agencies.update.wrapper import source_manager_update_agencies
from endpoints.v3.sync.data_sources.add.request import AddDataSourcesOuterRequest
from endpoints.v3.sync.data_sources.add.wrapper import source_manager_add_data_sources
from endpoints.v3.sync.data_sources.delete.wrapper import source_manager_delete_data_sources
from endpoints.v3.sync.data_sources.update.request import UpdateDataSourcesOuterRequest
from endpoints.v3.sync.data_sources.update.wrapper import source_manager_update_data_sources
from endpoints.v3.sync.meta_urls.add.request import AddMetaURLsOuterRequest
from endpoints.v3.sync.meta_urls.add.wrapper import source_manager_add_meta_urls
from endpoints.v3.sync.meta_urls.delete.wrapper import source_manager_delete_meta_urls
from endpoints.v3.sync.meta_urls.update.request import UpdateMetaURLsOuterRequest
from endpoints.v3.sync.meta_urls.update.wrapper import source_manager_update_meta_urls
...
def get_follows(
    ...
    return DatabaseClient().run_query_builder(GetUserFollowsSourceCollectorQueryBuilder())
