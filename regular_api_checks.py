...
def test_quicksearch_officer_involved_shootings_philadelphia_results():
    response = requests.get(
        "https://data-sources.pdap.io/api/quick-search/Officer Involved Shootings/philadelphia", headers=HEADERS
    )
...
def test_quicksearch_officer_involved_shootings_philadelphia_county_results():
    response = requests.get(
        "https://data-sources.pdap.io/api/quick-search/Officer Involved Shootings/philadelphia county", headers=HEADERS
    )
...
def test_quicksearch_all_allgeheny_results():
    response = requests.get("https://data-sources.pdap.io/api/quick-search/all/allegheny", headers=HEADERS)

    return len(response.json()["data"]) > 0


def test_quicksearch_complaints_all_results():
    response = requests.get("https://data-sources.pdap.io/api/quick-search/complaints/all", headers=HEADERS)

    return len(response.json()["data"]) > 0


def test_quicksearch_media_bulletin_pennsylvania_results():
    response = requests.get("https://data-sources.pdap.io/api/quick-search/media bulletin/pennsylvania", headers=HEADERS)
...
def test_data_source_by_id():
    response = requests.get("https://data-sources.pdap.io/api/data-sources-by-id/reczwxaH31Wf9gRjS", headers=HEADERS)

    return response.json()["data_source_id"] == "reczwxaH31Wf9gRjS"


def test_data_sources():
    response = requests.get("https://data-sources.pdap.io/api/data-sources", headers=HEADERS)
...
def test_data_source_by_id_approved():
    response = requests.get("https://data-sources.pdap.io/api/data-sources-by-id/rec013MFNfBnrTpZj", headers=HEADERS)
...
def test_search_tokens_data_sources():
    response = requests.get("https://data-sources.pdap.io/api/search-tokens?endpoint=data-sources")
...
def test_get_user():
    response = requests.get(
        "https://data-sources.pdap.io/api/user", headers=HEADERS, json={"email": "test2", "password": "test"}
    )
...
def test_get_archives():
    response = requests.get("https://data-sources.pdap.io/api/archives", headers=HEADERS)
...
# agencies
def test_agencies():
    response = requests.get("https://data-sources.pdap.io/api/agencies/1", headers=HEADERS)

    return len(response.json()["data"]) > 0


def test_agencies_pagination():
    response1 = requests.get("https://data-sources.pdap.io/api/agencies/1", headers=HEADERS)
    response2 = requests.get("https://data-sources.pdap.io/api/agencies/2", headers=HEADERS)

    return response1 != response2


def main():
    tests = ["test_quicksearch_officer_involved_shootings_philadelphia_results", 
