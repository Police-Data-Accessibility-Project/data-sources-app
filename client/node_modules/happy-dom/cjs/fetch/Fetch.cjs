...
class Fetch {
     ...
     */
    async send() {
        FetchRequestReferrerUtility_js_1.default.prepareRequest(__classPrivateFieldGet(this, _Fetch_window, "f").location, this.request);
    ...
    async compliesWithCrossOriginPolicy() {
        if (this.disableCrossOriginPolicy ||
            !FetchCORSUtility_js_1.default.isCORS(__classPrivateFieldGet(this, _Fetch_window, "f").location, this.request[PropertySymbol.url])) {
            return true;
        }
    ...
    onResponse(nodeResponse) {
        ...
        if (this.request.method === 'HEAD' ||
            ...
            this.response = new (__classPrivateFieldGet(this, _Fetch_window, "f").Response)(body, responseOptions);
            ...
            case 'follow':
                ...
                if (this.request.credentials === 'omit' ||
                    (this.request.credentials === 'same-origin' &&
                        FetchCORSUtility_js_1.default.isCORS(__classPrivateFieldGet(this, _Fetch_window, "f").location, locationURL))) {
