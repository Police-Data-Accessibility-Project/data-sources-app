...
class BrowserFrame {
     ...
     */
    goto(url, options) {
        return BrowserFrameNavigator_js_1.default.goto(BrowserWindow_js_1.default, this, url, options);
    }
    /**
     ...
     */
    reload(options) {
        return BrowserFrameNavigator_js_1.default.goto(BrowserWindow_js_1.default, this, this.url, options);
    }
}
