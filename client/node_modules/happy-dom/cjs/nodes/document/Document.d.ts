...
export default class Document extends Node implements IDocument {
    #private;
    [PropertySymbol.children]: IHTMLCollection<IElement>;
    [PropertySymbol.activeElement]: IHTMLElement;
    [PropertySymbol.nextActiveElement]: IHTMLElement;
    [PropertySymbol.currentScript]: IHTMLScriptElement;
    ...
    [PropertySymbol.defaultView]: IBrowserWindow | null;
    [PropertySymbol.ownerWindow]: IBrowserWindow;
     ...
     * @returns Default view.
     */
    get defaultView(): IBrowserWindow | null;
    /**
