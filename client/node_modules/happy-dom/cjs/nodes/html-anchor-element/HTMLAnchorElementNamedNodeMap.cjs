...
class HTMLAnchorElementNamedNodeMap extends HTMLElementNamedNodeMap_js_1.default {
    ...
    setNamedItem(item) {
        ...
        if (item[PropertySymbol.name] === 'rel' &&
            ...
            this[PropertySymbol.ownerElement][PropertySymbol.url] = HTMLAnchorElementUtility_js_1.default.getUrl(this[PropertySymbol.ownerElement].ownerDocument, item[PropertySymbol.value]);
        }
