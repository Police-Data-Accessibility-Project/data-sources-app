...
from tests.fixtures import dev_db_connection, flask_client_with_db, dev_db_client, test_user_admin
...
def test_refresh_session_post(test_user_admin, flask_client_with_db):
    ...
    jwt_tokens = login_and_return_jwt_tokens(flask_client_with_db, test_user_admin.user_info)
