...
from endpoints.v3.sync.agencies.update.request import UpdateAgenciesOuterRequest, UpdateAgenciesInnerRequest
...
def test_source_manager_agencies_update_happy_path(
    ...
    api_test_helper.request_validator.post_v3(
        url=f"/source-manager/agencies/update",
    ...
    assert agency_1["no_web_presence"] == True
    ...
    assert agency_2["agency_type"] == AgencyType.COURT.value
    assert agency_2["no_web_presence"] == True
