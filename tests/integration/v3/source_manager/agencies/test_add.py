...
from endpoints.v3.sync.agencies.add.request import AddAgenciesOuterRequest, AddAgenciesInnerRequest
...
def test_source_manager_agencies_add(
    ...
    assert agency_1["no_web_presence"] == False
    assert agency_1["defunct_year"] == None
    ...
    assert agency_2["no_web_presence"] == False
