from middleware.primary_resource_logic.github_issue_app_logic import get_github_issue_title, get_github_issue_body
...
def test_get_github_issue_body():
    ...
    assert result == """Submission Notes: Test issue
