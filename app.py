...
api.add_resource(DataSourceById, "/data-sources-by-id/<data_source_id>", resource_class_kwargs={"psycopg2_connection": psycopg2_connection})
api.add_resource(Agencies, "/agencies/<page>", resource_class_kwargs={"psycopg2_connection": psycopg2_connection})
api.add_resource(SearchTokens, "/search-tokens", resource_class_kwargs={"psycopg2_connection": psycopg2_connection})
