...
class RecordTypeMapper:
    def __init__(self, mappings: list[RecordTypeMapping]):
        ...
        for mapping in mappings:
            ...
            self._rc_id_to_category[mapping.record_category_id] = (
                mapping.record_category
            )
            self._category_to_rc_id[mapping.record_category] = (
                mapping.record_category_id
            )
    ...
    def get_record_category_id_by_record_category(
        self, record_category: RecordCategoryEnum
    ) -> int:
        return self._category_to_rc_id[record_category]

    def get_record_category_by_record_category_id(
        self, record_category_id: int
    ) -> RecordCategoryEnum:
