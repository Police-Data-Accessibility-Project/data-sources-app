...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        user_id_column(),
        enum_column(
            column_name="capacity", enum_name=ENUM_NAME, enum_values=ENUM_VALUES
        ),
        sa.UniqueConstraint(
            "user_id", "capacity", name="user_capacities_user_id_capacity_key"
        ),
    )
...
def downgrade() -> None:
    ...
    op.drop_column(PENDING_USER_TABLE_NAME, CAPACITIES_COLUMN_NAME)
