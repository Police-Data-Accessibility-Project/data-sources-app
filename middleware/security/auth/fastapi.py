...
def get_source_collector_access_info(token: Annotated[str, Depends(oauth2_scheme)]) -> AccessInfoPrimary:
    return check_access(token, PermissionsEnum.SOURCE_COLLECTOR)

def get_standard_access_info(token: Annotated[str, Depends(oauth2_scheme)]) -> AccessInfoPrimary:
