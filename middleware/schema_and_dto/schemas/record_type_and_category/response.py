...
from middleware.schema_and_dto.schemas.record_type_and_category.record_category import (
    RecordCategorySchema,
)
from middleware.schema_and_dto.schemas.record_type_and_category.record_type import (
    RecordTypeSchema,
)
