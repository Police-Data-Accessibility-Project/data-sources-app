...
from middleware.schema_and_dto_logic.common_response_schemas import GetManyResponseSchemaBase, MessageSchema
from middleware.schema_and_dto_logic.util import get_json_metadata


def create_post_schema(
    entry_data_schema: Schema,
    description: str
) -> Type[Schema]:
